...
<head>
    ...
    <title>NGUYENCONGLUAT/Ecommerce</title>
            ...
            <div class="container">
                <div class="ht-left">
                    <div class="mail-service">
                        ...
                        nguyencongluat092001@gmail.com
                    </div>
                ...
                <div class="ht-right">
                    <a href="./home" class="login-panel"><i class="fa fa-user"></i>Logout</a>
            ...
            <div class="container">
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        ...
                        <li class="{{(request()->segment(1) == 'product') ? 'active' : ''}}"><a href="{{ url ('product') }}">Product</a>
                            <ul class="dropdown">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="footer-left">
                        ...
                        <ul>
                            <li>8 Ton That Thuyet· Ha Noi</li>
                            <li>Phone: +84 38.63.58.006</li>
                            <li>Email: nguyencongluat092001@gmail.com</li>
                        </ul>
